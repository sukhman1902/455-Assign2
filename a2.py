...
class CommandInterface:
    ...
    def recursive_solve(self):
        ...
        # Check if there is no more move to play
        ...
        # Check if there is still time with the probability of 20% for efficiency
        ...
        for move in moves:
            ...
            winning, winning_move = self.recursive_solve()
            self.undo_move(move)
            if winning is None:
                return None, None
            elif not winning:
    ...
    def solve(self, args):
        ...
        # The current play is the loser
            ...
            print(str(self.player) + f" {winning_move[i]}" for i in range(len(winning_move)))
